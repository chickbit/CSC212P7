...
public interface P6List<T> {
	...
	/**
	 * Add an item to the front of this list. The item should be at getIndex(0) after this call.
	 * 
	...
	/**
	 * Add an item to the back of this list. The item should be at getIndex(size()-1) after this call.
	 * 
	 * @param item the data to add to the list.
	 */
	...
	/**
	 * Add an item before ``index`` in this list. Therefore, {@code addIndex(item, 0)} is the same as {@code addFront(item)}.
	 * 
	 * @param item  the data to add to the list.
	...
	/**
	 * This is true if the list is empty. This is usually implemented by looking at size() but that's a bad idea for linked
	 * lists.
	 * 
